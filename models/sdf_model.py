...
class SdfModel(pl.LightningModule):
    ...
    def forward_with_plane_features(self, plane_features: torch.Tensor, xyz: torch.Tensor) -> torch.Tensor:
        '''
